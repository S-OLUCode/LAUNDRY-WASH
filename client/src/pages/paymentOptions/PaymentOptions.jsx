      ...
      <div className="container mx-auto px-8 py-6">
        ...
        <div className="mt-4 flex flex-col items-center w-full">
          {payOptions.map((item) => (
            <div
              key={item.id}
              className="px-4 py-4 mx-20 bg-greenish-black rounded-xl flex text-white justify-between w-full items-center mb-6 max-w-[580px]"
            >
              ...
              <input
                type="radio"
                name="radio-1"
                className="radio scale-75 text-wash-purple border border-wash-purple bg-greenish-black"
          ...
          <div className="w-full max-w-[580px]">
            <div className="grid grid-cols-12 gap-4 lg:items-center mt-2">
              ...
              <button
                className="col-span-12 cursor-pointer lg:col-span-6 text-center bg-wash-purple px-4 py-3 rounded-full text-xs text-white flex item-center justify-center gap-2"
                onClick={makePayment}
        ...
        {isModalOpen && (
          <Modal
            ...
            classname="bg-grayish-black p-4 rounded-xl shadow-lg w-[90%] max-w-[400px] mx-auto"
            ...
            <div className="my-6  flex flex-col justify-center items-center">
              ...
              <div className="mt-4 text-center text-white">
                ...
                <div className="mt-6 grid grid-cols-1 gap-2 md:gap-4">
                  <button
                    type="submit"
                    className="bg-wash-purple py-3 text-white w-full rounded-full"
