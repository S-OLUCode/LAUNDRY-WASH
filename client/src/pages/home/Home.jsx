    ...
    <>
      <div className="container mx-auto md:px-8 md:py-6">
        <div className="space-y-6">
          ...
          <div className="flex gap-4 justify-center items-center text-lg mb-20">
            <div className="mt-2">
              <Link
                to="/book-laundry"
                className="text-wash-white bg-wash-purple px-4 py-2 rounded-full"
              >
                Book Laundry
              </Link>
            </div>
      ...
      <div className="container mx-auto md:px-10 py-6 bg-grayish-black md:mt-20">
        <div className="px-4 py-6 flex flex-col md:flex-row gap-6 text-center md:text-start md:gap-[170px] lg:gap-[400px] items-center ">
          <Link className="text-white text-md px-4 py-2 mb-15 bg-wash-purple rounded-full">
        ...
        <div className="container mx-auto px-4 py-6 grid grid-cols-12 gap-4">
          <div className="col-span-12 md:col-span-4 bg-greenish-black rounded-2xl">
            <img
              src="/laundryWash (2).svg"
              alt="wash & fold"
          ...
          <div className="col-span-12 md:col-span-4 bg-greenish-black rounded-2xl">
            <img src="/laundrywash.svg" alt="pickup" className="p-1 w-full" />
            <div className="text-white mt-4 p-2">
      ...
      <div className="container mx-auto md:px-10 py-6 mt-6">
        <div className="text-white text-center py-4 space-y-6">
          <div>
            <Link className="text-white text-md px-4 py-2 bg-wash-purple rounded-full">
              How It Works
            </Link>
          </div>
        ...
        <div className="md:grid grid-cols-12 gap-10 mt-10">
          <div className="col-span-12 md:col-span-4 text-center place-items-center">
            <img src="/calendar.svg" alt="schedule your services" />
          ...
          <div className="col-span-12 md:col-span-4 text-center place-items-center">
            <img src="/Keyhole.png" alt="keyhole" />
            <div className="text-white mt-4">
          ...
          <div className="col-span-12 md:col-span-4 text-center flex flex-col items-center">
            <img src="/trashYellow.svg" alt="delivery" />
            <div className="text-white mt-4">
      ...
      <div className="container mx-auto px-4 py-6 mt-10 space-y-6 flex flex-col md:flex-row gap-20 items-center">
        <div className="text-white space-y-4 md:w-[50%] text-center md:text-start md:px-10">
          <div>
            <Link className="text-md px-4 py-2 bg-wash-purple rounded-full">
              Who We Are
            </Link>
          </div>
        ...
        <div className="md:w-[60%]">
          <img
            src="/WashingMachines.svg"
            alt="laundry facility"
            className="rounded-2xl object-cover w-full md:w-[80%] md:ml-20"
          />
        </div>
      </div>
      <div className="container mx-auto md:px-8 py-6 mt-10 space-y-6">
        <div className="text-white text-center py-4 space-y-6">
          ...
          <section className="container mx-auto px-4 grid grid-cols-[repeat(auto-fit,minmax(300px,1fr))] gap-10 py-15">
            <div className="bg-greenish-black cardGradient rounded-tl-[35px] rounded-tr-[35px] rounded-br-[40px] rounded-bl-[40px] cursor-pointer">
              <div className="p-5 text-sm  bg-greenish-black rounded-tr-[30px] rounded-tl-[30px]  rounded-br-[30px]">
                <span className="flex gap-3 pb-3">
                  <img src="/4Star.svg" alt="" />
                  <span>4/5</span>
                </span>
                <p>
              ...
              <div className="bg-wash-purple rounded-tl-[40px] rounded-br-[40px] rounded-bl-[40px] p-2">
                <span className="p-2">
                  <div className="flex px-2 gap-3">
                    <img src="/ProfileOfUser.svg" alt="" />
                    <div>
      ...
      <div className="container mx-auto bg-grayish-black">
        <div className="md:mt-6 space-y-6 flex flex-col md:flex-row md:gap-20 items-center w-full">
          <div className="w-full md:w-[50%]">
            <img
              src="/FooterLaundry.svg"
              alt="laundry facility"
              className="rounded-2xl object-cover"
            />
          </div>
          <div className="container mx-auto px-8 text-white space-y-4 w-full text-center md:text-start md:w-[50%]">
            <h1 className="text-2xl lg:text-5xl font-bold mt-6">
            ...
            <div>
              <Link
                to="/book-laundry"
                className="text-xs py-5 bg-wash-purple rounded-full"
              >
                <button className="cursor-pointer mt-4 w-full text-lg">
                  Book Laundry
                </button>
              </Link>
            </div>
