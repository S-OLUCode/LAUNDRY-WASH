...
import { validateBookingSchema } from "@/utils/dataSchema.js";
      ...
      {path === "/book-laundry" ? (
        <>
          <div className="container mx-auto max-w-[580px] px-4 py-6 space-y-4">
            <div className="container mx-auto max-w-[381px] mt-4">
            ...
            <form className="space-y-2" onSubmit={handleSubmit(onSubmit)}>
              <div className="mt-10">
                ...
                <div className="bg-greenish-black px-2 py-3 rounded-lg text-greenish-black">
              ...
              <div>
                ...
                <div className="bg-greenish-black px-2 py-4 rounded-lg">
                  ...
                  <div className="mt-2 text-greenish-black">
                  ...
                  <div className="grid grid-cols-12 gap-4 lg:items-center mt-2">
                    <div className="col-span-12 lg:col-span-6 text-greenish-black">
              ...
              <div>
                ...
                <div className="bg-greenish-black px-2 py-4 rounded-lg">
                  <div className="text-greenish-black">
                    <span className="text-xs text-white">Address</span>
                    <input
                      type="text"
                  ...
                  <div className="mt-2 text-grayish-black">
                    <span className="text-xs text-white">Phone Number</span>
                    <input
                      type="tel"
                      placeholder="+234803878218"
              ...
              <div className="text-grayish-black">
                <h2 className=" font-semibold text-white mb-2">Add item</h2>

                <div className="grid grid-cols-12 gap-2 lg:items-center mt-2 bg-greenish-black px-2 py-4 rounded-lg">
              ...
              <div className="grid grid-cols-12 gap-4 lg:items-center mt-4">
                ...
                <button
                  type="submit"
                  className="col-span-12 cursor-pointer lg:col-span-6 text-center bg-wash-purple px-4 py-3 rounded-full text-xs text-white"
                >
                  Proceed To Summary
                </button>
              </div>
